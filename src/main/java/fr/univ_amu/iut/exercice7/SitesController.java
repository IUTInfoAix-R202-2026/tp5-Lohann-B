...
public class SitesController {
  ...
  private void initialize() {
    ...
    choiceProtocole.setItems(FXCollections.observableArrayList(viewModel.listeProtocoles()));

    boutonSupprimer
        .disableProperty()
        .bind(Bindings.isNull(tableSites.getSelectionModel().selectedItemProperty()));
  }
